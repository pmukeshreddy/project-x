...
| M1 | `/root/m1_sources` | Fix round1 implementing all7 findings against approved v2 schemas | Git boundary review before real cached rerun, then full re-review |
...
| M3 | `/root/m3_runtime` | Trusted sandbox probe complete; inert dependency preparation finishing; no product code | M2 provider review then lifecycle/baseline implementation |
