...
| M1 | `/root/m1_sources` | Fix source checkpoint5587c6b; owner reports146 tests passed | Reviewer checks Git boundary before real cached rerun, then full re-review |
