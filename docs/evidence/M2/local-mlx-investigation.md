...
- the process exited 0 in 4.524 seconds with 5,010 retained output bytes, zero stderr, 2.393 GB MLX peak allocation, a 2,721,450,408-byte maximum sampled physical footprint, and a distinct 2,726,381,992-byte kernel lifetime-maximum observation; and
