...
try:
    ...
    for name in names:
        ...
        receipt["legacy_receipts"][name] = {
            ...
            "wall_seconds_in_response": response.get("wall_seconds"),
            "wall_measurement_present_in_response": "wall_seconds" in response,
            "wall_seconds_in_cost": data["archives"]["cost"]["wall_seconds"],
